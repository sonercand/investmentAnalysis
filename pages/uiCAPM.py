...
from Calculations.portfolioOptimisationCAPM import (
    maximizePortfolioReturns,
    processData,
    portfolioReturn,
    portfolioRisk,
    portfolioESGscore,
...
def optimise(
    ...
    if n_clicks > 0:
        ...
        ### Portfolio Holdings ##########################################
        list_ = list(zip(tickers, optWeightsS))
        ...
        esgScoreC = portfolioESGscore(optWeightsS, esgData)
